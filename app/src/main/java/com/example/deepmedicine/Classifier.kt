...
class Classifier(assetManager: AssetManager, modelPath: String, labelPath: String, private val inputSize: Int) {
    ...
    data class Recognition(var id: String = "", var title: String = "", var confidence: Float = 0F) {
    ...
    private fun getSortedResult(labelProbArray: Array<FloatArray>): List<Recognition> {
        ...
        recognitions.add(Recognition("" + 0, labelList[0], uninfected))
        recognitions.add(Recognition("" + 1, labelList[1],  parasitized))
        return recognitions
    }
